...
begin
  ...
  -- This automatic operation is deliberately limited to fresh duplicate registrations.
  -- If the duplicate already owns business/history rows, stop instead of guessing how to merge them.
  for v_fk in
