-- P30C6 — API pública de cálculo por tarjeta.
...
set search_path=''
as $$
declare v_from timestamptz; v_to timestamptz; v_value numeric;
begin
  ...
  else raise exception 'Métrica no soportada: %',p_metric_key using errcode='22023'; end if;
