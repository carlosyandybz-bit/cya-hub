-- Mantiene el perfil profesional dentro del backup/restauración canónicos P28/P32.
...
as $$
  select case p_domain
    when 'people' then array[
      'people','student_profiles','teacher_profiles','teacher_profile_styles','student_dance_profiles','crm_profiles','crm_activities',
    ...
    when 'complete' then array[
      ...
      'people','student_profiles','teacher_profiles','teacher_profile_styles','crm_profiles','crm_activities','student_dance_profiles',
