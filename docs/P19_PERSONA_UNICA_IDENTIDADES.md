...
- `private.link_confirmed_student`: vincula Auth por email a la persona existente cuando la coincidencia es inequívoca y no usa nombres genéricos como fallback.
