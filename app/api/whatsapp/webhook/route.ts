...
export async function POST(request: NextRequest) {
  ...
  // Signature-verified payloads are acknowledged now. Persisting delivery/read states
  // will be added only with an explicitly approved, backward-compatible production migration.
  try {
    JSON.parse(rawBody);
  } catch {
