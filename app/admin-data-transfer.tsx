    ...
    <div className="admin-content-grid">
      ...
      <article className="card pad">
        ...
        {isBackup && importPreview ? <div className="admin-stack">
          <div className="status-list"><div><ShieldCheck /> Restauración no destructiva: actualiza/recupera registros sin borrar filas adicionales.</div><div><ShieldCheck /> Secretos y credenciales existentes se conservan y nunca se importan desde el archivo.</div>{missingAuth.length ? <div>Faltan {missingAuth.length} usuarios de acceso en Supabase Auth; la restauración está bloqueada.</div> : <div><ShieldCheck /> Todas las identidades Auth requeridas existen.</div>}</div>
